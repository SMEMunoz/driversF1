...
Driver.belongsToMany(Team, { through: 'drivers_equipos', as: 'teams' });
Team.belongsToMany(Driver, { through: 'drivers_equipos', as: 'drivers' });
// User.belongsToMany(Team, { through: 'drivers_equipos', as: 'users' });
